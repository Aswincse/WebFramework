...
public class AswinChildren {
    ...
    public AswinChildren() {
    }
    public AswinChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
